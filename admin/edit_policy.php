...
$update_query=mysqli_query($con,"select * from policy where id='".$_REQUEST['id']."' ");
...
if(isset($_POST['edit_policy']))
{
  ...
  $query=mysqli_query($con,"update policy set heading='".$heading."',description='".$description."',date='".$date."' where id='".$_REQUEST['id']."' ");
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="edit_policy" value="Update policy" class="btn btn-primary"/>
                    </div>
                  </div>
