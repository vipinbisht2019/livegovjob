...
$update_query=mysqli_query($con,"select * from meta_keyword where id='".$_REQUEST['id']."' ");
$row=mysqli_fetch_array($update_query);

if(isset($_POST['edit_meta_keyword']))
{
	$url=$_POST['url'];
	$title=$_POST['title'];
  ...
  $query=mysqli_query($con,"update meta_keyword set url='".$url."',title='".$title."',keyword='".$keyword."',description='".$description."',date='".$date."',time='".$time."' where id='".$_REQUEST['id']."' ");
	
   echo"<script>alert('Data has Updated Successfully!')</script>'";
   echo"<script>window.open('view_meta_keyword.php','_self')</script>";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Manage Meta Keyword</a></li>
        <li class="active">Edit Meta Keyword</li>
	  </ol>
    </section>
               ...
               <textarea class="textarea" name="description" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row['description']; ?></textarea>
				  ...
				  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="edit_meta_keyword" value="Edit Meta Keyword" class="btn btn-primary"/>
                    </div>
                  </div>
