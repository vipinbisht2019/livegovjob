...
$update_query=mysqli_query($con,"select * from terms where id='".$_REQUEST['id']."' ");
...
if(isset($_POST['edit_terms']))
{
  ...
  $query=mysqli_query($con,"update terms set heading='".$heading."',description='".$description."',date='".$date."' where id='".$_REQUEST['id']."' ");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">Update Terms</li>
	  </ol>
    </section>
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="edit_terms" value="Update terms" class="btn btn-primary"/>
                    </div>
                  </div>
