...
if(isset($_POST['add_private_job']))
{
	...
	$query=mysqli_query($con, "insert into private_job(`menu_id`,`heading`,`job_link`,`comp_name`,`designation`,`education`,`location`,
	`experience`,`salary`,`job_profile`,`vacancy`,`job_type`,`contact_person`,`comp_add`,`walkin_date`,`walkin_venue`,
	`last_date`,`date`)values( '".$menu_id."','".$heading."','".$job_link."','".$comp_name."','".$designation."',
	'".$education."','".$location."','".$experience."','".$salary."','".$job_profile."','".$vacancy."','".$job_type."','".$contact_person."',
	'".$comp_add."','".$walkin_date."','".$walkin_venue."'	,'".$last_date."','".$date."') ");
  
  header('location:add_private_job.php');
              ...
              <form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
				...
				<div class="form-group">
                  <label for="job profile" class="col-sm-2 control-label">Job Profile <span class="sp">*</span></label>
					<div class="col-sm-6">
                        <textarea id="editor1" name="job_profile" rows="10" cols="40" required > </textarea>
                    </div>	
				</div>
				...
				<div class="form-group">
                  <label for="company add" class="col-sm-2 control-label">Company Address <span class="sp">*</span></label>
					...
					<div class="col-sm-6">	
               <textarea class="textarea" name="comp_add" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="walkin date" class="col-sm-2 control-label">Walkin Date<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="walkin_date" required>
						</div>
				</div>
				...
				<div class="form-group">
                  <label for="walkin venue" class="col-sm-2 control-label">Walkin Venue <span class="sp">*</span></label>
					...
					<div class="col-sm-6">	
               <textarea class="textarea" name="walkin_venue" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
					</div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="add_private_job" value="Add Private Job" class="btn btn-primary"/>
                    </div>
                  </div>
