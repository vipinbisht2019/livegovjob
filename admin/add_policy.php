...
if(isset($_POST['add_policy']))
{
  ...
  $query=mysqli_query($con, "insert into policy(`heading`,`description`,`date`)values('".$heading."','".$description."','".$date."') ");
   
   header('location:add_policy.php');
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="add_policy" value="add_policy" class="btn btn-primary"/>
                    </div>
                  </div>
