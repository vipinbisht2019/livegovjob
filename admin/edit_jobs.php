...
$update_jobs=mysqli_query($con,"select * from jobs where id='".$_REQUEST['id']."' ");
$row_jobs=mysqli_fetch_array($update_jobs);
...
if(isset($_POST['edit_jobs']))
{
	...
	$time=date('h:i');
	  ...
	  if(empty($img))
	{
		$query=mysqli_query($con,"update jobs set menu_id='".$menu_id."',job_cat_id='".$job_cat_id."',job_subcat_id='".$job_subcat_id."',heading_prev='".$heading_prev."',
	description_prev='".$description_prev."',notification_prev='".$notification_prev."',qualification='".$qualification."',eligible='".$eligible."',
	link1='".$link1."',link2='".$link2."',heading='".$heading."',keywords='".$keywords."',top_paragraph='".$top_paragraph."',
	company='".$company."',post='".$post."',total_post='".$total_post."',salary='".$salary."',all_salary='".$all_salary."',state='".$state."',
	location='".$location."',last_date='".$last_date."',bottom_paragraph='".$bottom_paragraph."',date='".$date."',
	time='".$time."' where id='".$_REQUEST['id']."' ");
	}
	else {
 ...
 $query=mysqli_query($con,"update jobs set menu_id='".$menu_id."',job_cat_id='".$job_cat_id."',job_subcat_id='".$job_subcat_id."',heading_prev='".$heading_prev."',
	description_prev='".$description_prev."',notification_prev='".$notification_prev."',qualification='".$qualification."',eligible='".$eligible."',
	link1='".$link1."',link2='".$link2."',heading='".$heading."',image='".$proper_img."',keywords='".$keywords."',top_paragraph='".$top_paragraph."',
	company='".$company."',post='".$post."',total_post='".$total_post."',salary='".$salary."',all_salary='".$all_salary."',state='".$state."',
	location='".$location."',last_date='".$last_date."',bottom_paragraph='".$bottom_paragraph."',date='".$date."',
	time='".$time."' where id='".$_REQUEST['id']."' "); 
		...
		<div class="box-header">
              <form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
				...
				<div class="form-group">
				  ...
				  <option value="<?php echo $menu_row['id']; ?>" <?php if($menu_row['id']==$row_jobs['menu_id']) echo 'selected'; ?> > <?php echo $menu_row['categories']; ?> </option>
				...
				<div class="form-group">
                  <label for="job_cat_id" class="col-sm-2 control-label">Select Sub Category <span class="sp">*</span></label>
					...
					{   
						$rr=$job_category_row['id'];
				?>		  
<option value="<?php echo $job_category_row['id']; ?>" <?php if($job_category_row['id']==$row_jobs['job_cat_id'])  { echo 'selected'; $ss=$rr; } ?> > <?php echo $job_category_row['job_name']; ?> </option>		  
					<?php } ?>
				   		</select>
					</div>
                </div>
                  ...
                  <label for="job_subcat_id" class="col-sm-2 control-label">Select Jobs<span class="sp">*</span></label>
					<div class="col-sm-6">
						<select name="job_subcat_id" id="job_subcategory" class="form-control" required>
							...
							<?php
						$get_job_subcategory=mysqli_query($con,"select * from job_sub_category");
						while($job_subcategory_row=mysqli_fetch_array($get_job_subcategory))
					{ ?>		  
				
				<?php
									if( $job_subcategory_row['job_cat_id'] == $ss ) {  
											
											} else {  continue; }	
												
												if($job_subcategory_row['id'] == $row_jobs['job_subcat_id'])
												{
													$check='selected';
												} else
												{
				...
				?>
				  ...
				  <option value="<?php echo $job_subcategory_row['id']; ?>" <?php echo $check; ?> > <?php echo $job_subcategory_row['job_name']; ?> </option>		  
					<?php } ?>
				 ...
				 <div class="form-group">
					<label for="heading prev" class="col-sm-2 control-label">Heading Prev <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="heading_prev" value="<?php echo $row_jobs['heading_prev']; ?>" required>
						</div>
				</div>
				 ...
				 <div class="form-group">
					<label for="description prev" class="col-sm-2 control-label">description Prev <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="description_prev" value="<?php echo $row_jobs['description_prev']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="notification prev" class="col-sm-2 control-label">Notification Prev <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="notification_prev" value="<?php echo $row_jobs['notification_prev']; ?>" required>
						</div>
				</div>
                ...
                <div class="form-group">
					<label for="qualification" class="col-sm-2 control-label">Qualification <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="qualification" value="<?php echo $row_jobs['qualification']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="eligible" class="col-sm-2 control-label">Eligible <span class="sp">*</span></label>
						...
						<select name="eligible" class="form-control" required>
							<option value="<?php echo $row_jobs['eligible']; ?>"> <?php echo $row_jobs['eligible']; ?></option>		  
				...
				<div class="form-group">
					<label for="link1" class="col-sm-2 control-label">Link 1<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="link1" value="<?php echo $row_jobs['link1']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="link2" class="col-sm-2 control-label">Link 2 <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="link2" value="<?php echo $row_jobs['link2']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="heading" class="col-sm-2 control-label">Heading<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="heading" value="<?php echo $row_jobs['heading']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
                  <label for="image" class="col-sm-2 control-label">Image <span class="sp">*</span></label>
				    <div class="col-sm-6">
					  <input type="file" class="form-control" name="images" id="exampleInputFile" >                  
					</div>	
				</div>
				...
				<div class="form-group">
                  <label for="job_keywords" class="col-sm-2 control-label">Job Keywords <span class="sp">*</span></label>
					...
					<div class="col-sm-6">	
               <textarea class="textarea" name="keywords" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo $row_jobs['keywords']; ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
                  <label for="top_paragraph" class="col-sm-2 control-label">Top Paragraph <span class="sp">*</span></label>
					...
					<div class="col-sm-6">	
               <textarea class="textarea" name="top_paragraph" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row_jobs['top_paragraph']; ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="Company" class="col-sm-2 control-label">Company<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="company" value="<?php echo $row_jobs['company']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="Post" class="col-sm-2 control-label">Post<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="post" value="<?php echo $row_jobs['post']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="total_post" class="col-sm-2 control-label">Total Post<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="total_post" value="<?php echo $row_jobs['total_post']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="salary" class="col-sm-2 control-label">Salary<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="salary" value="<?php echo $row_jobs['salary']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="All Salary" class="col-sm-2 control-label">All salary <span class="sp">*</span></label>
						...
						<select name="all_salary" class="form-control" required>
							<option value="<?php echo $row_jobs['all_salary']; ?>"> <?php echo $row_jobs['all_salary']; ?></option>		  
				...
				<div class="form-group">
					<label for="state" class="col-sm-2 control-label">State<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="state" value="<?php echo $row_jobs['state']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="location" class="col-sm-2 control-label">Location<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="location" value="<?php echo $row_jobs['location']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="last date" class="col-sm-2 control-label">Last Date<span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="last_date" value="<?php echo $row_jobs['last_date']; ?>" required>
						</div>
				</div>
				...
				<div class="form-group">
                  <label for="bottom_paragraph" class="col-sm-2 control-label">Bottom Paragraph <span class="sp">*</span></label>
					<div class="col-sm-6">
                        <textarea id="editor1" name="bottom_paragraph" rows="10" cols="40" required > <?php echo $row_jobs['bottom_paragraph']; ?></textarea>
                    </div>	
				</div>
				
				  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="edit_jobs" value="Edit Jobs" class="btn btn-primary"/>
                    </div>
                  </div>
