...
if(isset($_POST['add_job_category']))
{
	...
	$query=mysqli_query($con, "insert into job_category(`menu_id`,`job_name`,`job_title`,`heading`,`job_link`,`image`,`job_category_keywords`,`top_paragraph`,`eligible`,`job_location`,`total_vacancy`,`start_date`,`last_date`,`bottom_paragraph`,`date`,`time`)values('".$menu_id."',
  '".$job_name."','".$job_title."','".$heading."','".$job_link."','".$img."','".$job_category_keywords."','".$top_paragraph."','".$eligible."','".$job_location."','".$total_vacancy."','".$start_date."','".$last_date."','".$bottom_paragraph."','".$date."','".$time."') ");
  
  header('location:add_job_category.php');
              ...
              <form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
				...
				<div class="form-group">
                  <label for="job_category_keywords" class="col-sm-2 control-label">Job Category Keywords <span class="sp">*</span></label>
					...
					<div class="col-sm-6">	
               <textarea class="textarea" name="job_category_keywords" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
					</div>
				</div>
               ...
               <textarea class="textarea" name="top_paragraph" rows="10"  style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
				...
				<div class="form-group">
					<label for="eligible" class="col-sm-2 control-label">Eligible <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="eligible" required>
						</div>
				</div>
				...
				<div class="form-group">
					<label for="total_vacancy" class="col-sm-2 control-label">Total Vacancy <span class="sp">*</span></label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="total_vacancy" required>
						</div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="add_job_category" value="Add Job Category" class="btn btn-primary"/>
                    </div>
                  </div>
