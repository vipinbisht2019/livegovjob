...
if(isset($_POST['add_logo']))
{
  ...
  $query=mysqli_query($con, "insert into web_logo(`favicon_image`,`logo_image`,`status`)values('".$img1."','".$img2."','".$status."') ");
  
  header('location:add_web_logo.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">Add Web Logo</li>
	  </ol>
    </section>
		...
		<div class="box-header">
               ...
               <div class="form-group">
                  <label for="favicon_image" class="col-sm-2 control-label">Favicon Image <span class="sp">*</span></label>
				    <div class="col-sm-6">
					  <input type="file" class="form-control" name="favicon_image" id="exampleInputFile" required />                  
					</div>	
				</div>
				...
				<div class="form-group">
                  <label for="logo_image" class="col-sm-2 control-label">Website Image <span class="sp">*</span></label>
				    <div class="col-sm-6">
					  <input type="file" class="form-control" name="logo_image" id="exampleInputFile" required />                  
					</div>	
				</div>			
				  
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" name="add_logo" value="add_logo" class="btn btn-primary"/>
                    </div>
                  </div>
